...
namespace ReadingBusesAPI
{
    ...
    public sealed class LiveRecord
    {
        ...
        /// <value>Holds the 'Via' message, which explains where the bus is traveling past on route. Can be null or a place holder value if none exists.</value>
        ...
        /// <exception cref="InvalidOperationException">Can throw an exception if the service does not exists. This is however very unlikely, if this occurs there is an error in the API, not with your code.</exception>
